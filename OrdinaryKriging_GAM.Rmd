...
v <- variogram(gs,width=10000,cutoff=450000)
plot(v)
```
...
```{r}
vmod <- vgm(psill=max(v$gamma), model="Exp", range=200000,nugget=min(v$gamma))
```
...
```
    ...
    k-fold Cross validation (with k = 10) to determine the best fit with Ordinary Kriging
...
for (i in 1:k) {
  ...
  vY <- variogram(gsY,width=10000,cutoff=250000)
  ...
  vX <- variogram(gsX,width=10000,cutoff=250000)
  ...
  vdp <- variogram(gsdp,width=10000,cutoff=250000)
  ...
  vYX <- variogram(gsYX,width=10000,cutoff=250000)
  ...
  vYdp <- variogram(gsYdp,width=10000,cutoff=450000)
  ...
  vXdp <- variogram(gsXdp,width=10000,cutoff=250000)
